...
public class AeroCheckOld {
    ...
    private static void singlePassengerCheckIn(Scanner read) {
        ...
        long passNum = getValidLong(read, "Invalid Passport number. Please enter a valid Passport number.");

        System.out.println("Date of Flight (dd/mm/yyyy): ");
        LocalDate dateOfFlight = getValidDate(read, "Invalid Date. Please enter valid Date.");
